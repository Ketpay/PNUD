# Generated by Django 4.0.3 on 2022-09-19 10:16
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'ao_acces',
                'verbose_name_plural': 'ao_acces',
            },
        ),
        migrations.CreateModel(
            name='ao_need',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submeta', models.CharField(blank=True, max_length=255)),
                ('capa_datos', models.CharField(blank=True, max_length=255)),
                ('codigo_idso', models.CharField(blank=True, max_length=255)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meta', models.CharField(blank=True, max_length=255)),
                ('submeta', models.CharField(blank=True, max_length=255)),
                ('descripccion_punto_referencia', models.CharField(blank=True, max_length=255)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('anio', models.PositiveIntegerField(blank=True, default=0)),
                ('nombre_de_especies', models.CharField(blank=True, max_length=255)),
                ('valor', models.FloatField(blank=True, default=0)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('anio', models.PositiveIntegerField(blank=True, default=0)),
                ('balneario', models.CharField(blank=True, max_length=255)),
                ('valor', models.FloatField(blank=True, default=0)),
            ],
            options={
